...
function BlueSlime:load()
	...
	-- Collider
	self.collider = world:newBSGRectangleCollider(150, 150, 15, 15, 2)
	...
	-- Sprite and grid
	self.spriteSheet = love.graphics.newImage("sprites/enemies/blueSlime.png")
...
function BlueSlime:update(dt, player, sword)
...
function BlueSlime:weaponCollision(damage, sword, death_status)
